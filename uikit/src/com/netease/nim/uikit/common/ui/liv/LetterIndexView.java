...
public class LetterIndexView extends View {
    ...
    public LetterIndexView(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
        ...
        hintDrawable = paramContext.getResources().getDrawable(R.drawable.nim_contact_letter_view_hit_point,null);
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        ...
        case MotionEvent.ACTION_DOWN:
            hit = true;
            setBackgroundColor(getResources().getColor(R.color.contact_letter_idx_bg,null));

...
public final class NimUIKitImpl {
    ...
    */
    ...
    public static void startP2PSession(Context context, String account, String  Name) {
        NimUIKitImpl.startChatting(context, account, SessionTypeEnum.P2P, commonP2PSessionCustomization, Name);
    }
    ...
    public static void startChatting(Context context, String id, SessionTypeEnum sessionType, SessionCustomization
            customization, String  name) {
        if (sessionType == SessionTypeEnum.P2P) {
            P2PMessageActivity.start(context, id, customization, name);
        } else if (sessionType == SessionTypeEnum.Team) {
            TeamMessageActivity.start(context, id, customization, null, name);
        }
    }
